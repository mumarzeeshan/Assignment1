...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    MCQ_support.set_Tk_var()
    top = MCQ (root)
    MCQ_support.init(root, top)
    root.mainloop()
...
def create_MCQ(root, *args, **kwargs):
    ...
    MCQ_support.set_Tk_var()
    top = MCQ (w)
    MCQ_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class MCQ:
    def __init__(self, top=None):
        ...
        self.CorrectEntry.place(relx=0.81, rely=0.43, relheight=0.06
                , relwidth=0.06)
        ...
        self.CorrectEntry.configure(width=34)

        self.Label3 = Label(self.Frame1)
        self.Label3.place(relx=0.57, rely=0.43, height=26, width=129)
        ...
        self.Option1 = Entry(self.Frame1)
        self.Option1.place(relx=0.12, rely=0.29, relheight=0.06, relwidth=0.28)
        self.Option1.configure(background="white")
        self.Option1.configure(disabledforeground="#a3a3a3")
        self.Option1.configure(font="TkFixedFont")
        self.Option1.configure(foreground="#000000")
        self.Option1.configure(insertbackground="black")

        self.Option2 = Entry(self.Frame1)
        self.Option2.place(relx=0.12, rely=0.38, relheight=0.06, relwidth=0.28)
        self.Option2.configure(background="white")
        self.Option2.configure(disabledforeground="#a3a3a3")
        self.Option2.configure(font="TkFixedFont")
        self.Option2.configure(foreground="#000000")
        self.Option2.configure(insertbackground="black")

        self.Option3 = Entry(self.Frame1)
        self.Option3.place(relx=0.12, rely=0.46, relheight=0.06, relwidth=0.28)
        self.Option3.configure(background="white")
        self.Option3.configure(disabledforeground="#a3a3a3")
        self.Option3.configure(font="TkFixedFont")
        self.Option3.configure(foreground="#000000")
        self.Option3.configure(insertbackground="black")

        self.Option4 = Entry(self.Frame1)
        self.Option4.place(relx=0.12, rely=0.55, relheight=0.06, relwidth=0.28)
        self.Option4.configure(background="white")
        self.Option4.configure(disabledforeground="#a3a3a3")
        self.Option4.configure(font="TkFixedFont")
        self.Option4.configure(foreground="#000000")
        self.Option4.configure(insertbackground="black")
        ...
        self.SubmitButton = Button(self.Frame1,command=lambda: getDetails(self.MaxMarks.get(),self.QuestionEntry.get(),self.Option1.get(),self.Option2.get(),self.Option3.get(),self.Option4.get(),self.CorrectEntry.get(),self.QuizId.get()))
        self.SubmitButton.place(relx=0.47, rely=0.67, height=33, width=67)
        ...
        def getDetails(maxMarks,question,op1,op2,op3,op4,correctAnswer,quizId):
            type="MCQs"
            print maxMarks,question,correctAnswer,op1,op2,op3,op4
            Database.c.execute("INSERT INTO Question (QID,Type,Question,Answer,MaxMarks,Option1,Option2,Option3,Option4) VALUES(?,?,?,?,?,?,?,?,?)", (quizId,type,question, correctAnswer,maxMarks,op1,op2,op3,op4))
