...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    TF_support.set_Tk_var()
    top = TF (root)
    TF_support.init(root, top)
    root.mainloop()

w = None
def create_TF(root, *args, **kwargs):
    ...
    TF_support.set_Tk_var()
    top = TF (w)
    TF_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class TF:
    def __init__(self, top=None):
        ...
        self.CorrectEntry.place(relx=0.4, rely=0.42, relheight=0.09
                , relwidth=0.16)
        ...
        self.CorrectEntry.configure(width=104)

        self.Label3 = Label(self.Frame1)
        self.Label3.place(relx=0.33, rely=0.29, height=36, width=179)
        ...
        self.Label3.configure(width=179)
        ...
        self.Label4.place(relx=0.62, rely=0.06, height=26, width=88)
        ...
        self.SubmitButton.place(relx=0.42, rely=0.53, height=33, width=68)
        ...
        def getDetails(maxMarks,question,correctAnswer,quizId):
            type = "True False"
            #Database.c.execute("INSERT INTO Question VALUES(?,?,?,?,?,?,?,?,?)",(question,correctAnswer,t,maxMarks,"true","false",0,0,"Quiz1"))
            ...
            #Database.conn.close()
            print maxMarks,question,correctAnswer
            root.destroy()
            QuestionType.vp_start_gui()
